...
app = FastAPI(
    title="Quarterly Results RAG API",
    description=(
        "Retrieval augmented generation over quarterly earnings press releases "
        "filed with the SEC."
    ),
    version="1.0.0",
)
...
async def root() -> dict:
    return {"service": "Quarterly Results RAG API", "docs": "/docs"}
