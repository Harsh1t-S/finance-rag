...
<style>
  ...
  .hero-eyebrow {{
    ...
    color: #6EE7B7; font-weight: 700; margin-bottom: .5rem;
  }}
  .hero-title {{
  ...
  .pill-on  {{ background: rgba(52,211,153,.13); color: {ACCENT}; border: 1px solid rgba(52,211,153,.3); }}
  ...
  .meter-fill {{
    ...
    background: linear-gradient(90deg, #1E6F5C, {ACCENT});
  }}
  .src-sim {{
